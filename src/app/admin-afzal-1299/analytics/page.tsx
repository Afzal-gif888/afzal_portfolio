...
import { Users, UserCheck, Eye, Download, MousePointer, Activity, Briefcase } from "lucide-react";
...
export default function AnalyticsDashboard() {
  ...
  if (loading) {
    return <div className="text-center py-12 text-muted-foreground animate-pulse">Loading advanced analytics...</div>;
  }
